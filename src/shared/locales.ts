...
const SEORAP_KO = {
  ...
  'settings.cleanup': '오래된 보드 항목 자동 정리',
  'settings.cleanup_hint_a': '보드에서 고정하지 않은 항목이',
  'settings.cleanup_hint_b':
    '일 지나면 자동으로 지워요. 고정한 항목과 메모, 금고는 건드리지 않아요.',
  ...
  'settings.cleanup_confirm_desc':
    '{days}일보다 오래된, 고정하지 않은 보드 항목 {n}개를 지워요. 메모는 그대로 둬요. 이 작업은 되돌릴 수 없어요.',
...
const SEORAP_EN: Record<LocaleKey, string> = {
  ...
  'settings.cleanup': 'Clean up old board items automatically',
  'settings.cleanup_hint_a': 'Unpinned board items older than',
  'settings.cleanup_hint_b':
    'days are removed. Pinned items, notes and the vault are never touched.',
  ...
  'settings.cleanup_confirm_desc':
    'Removes {n} unpinned board items older than {days} days. Notes are left alone. This cannot be undone.',
